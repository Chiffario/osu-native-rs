...
impl DifficultyCalculator for OsuDifficultyCalculator {
    ...
    /// Create an instance of [`OsuDifficultyCalculator`]
    ///
    /// # Examples
    ///
    /// ```no_run
    ...
    /// let osu_calc = OsuDifficultyCalculator::new(ruleset, &beatmap)?;
    ...
    /// Calculates [`OsuDifficultyAttributes`]
    ///
    /// # Examples
    ///
    /// ```no_run
    ...
    /// let osu_calc = OsuDifficultyCalculator::new(ruleset, &beatmap)?;
    /// let attributes = osu_calc.calculate()?;
    /// # Ok::<(), Box<dyn std::error::Error>>(())
    /// ```
    /// # Errors
    ///
...
impl From<NativeOsuDifficultyAttributes> for OsuDifficultyAttributes {
    fn from(value: NativeOsuDifficultyAttributes) -> Self {
        Self {
            ...
            aim_top_weighted_slider_factor: value.aim_top_weighted_slider_factor,
            speed_top_weighted_slider_factor: value.speed_top_weighted_slider_factor,
            nested_score_per_object: value.nested_score_per_object,
            legacy_score_base_multiplier: value.legacy_score_base_multiplier,
            maximum_legacy_combo_score: value.maximum_legacy_combo_score,
...
impl From<&OsuDifficultyAttributes> for NativeOsuDifficultyAttributes {
    fn from(val: &OsuDifficultyAttributes) -> Self {
        NativeOsuDifficultyAttributes {
            ...
            aim_top_weighted_slider_factor: val.aim_top_weighted_slider_factor,
            speed_top_weighted_slider_factor: val.speed_top_weighted_slider_factor,
            nested_score_per_object: val.nested_score_per_object,
            legacy_score_base_multiplier: val.legacy_score_base_multiplier,
            maximum_legacy_combo_score: val.maximum_legacy_combo_score,
